...
from entity_taxonomy import classify_entity, CLASS_CONSUMER_COMPLAINT, CLASS_AFFILIATE_DISTRESS, CLASS_PROCESSOR_DISTRESS
...
FALLBACK_PATTERNS = {
    "Payout freezes and delays": ["payout", "deposit", "transfer"],
    "Account terminations": ["suspended", "closed", "terminated"],
    "Chargeback and dispute holds": ["chargeback", "dispute", "fraud"],
    "Processor reserve holds": ["reserve", "held", "withheld"],
...
def cluster_signals():
    ...
    for sig in signals:
        ...
        if classification == CLASS_CONSUMER_COMPLAINT:
